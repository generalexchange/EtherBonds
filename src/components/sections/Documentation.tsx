...
export function Documentation() {
  return (
    <section id="documentation" className="border-t border-navy-900/10 bg-ivory-50 px-6 py-20 lg:px-10">
      <div className="mx-auto max-w-[900px]">
        ...
        <FadeIn delay={0.16} className="mt-6 text-base leading-relaxed text-graphite-800">
